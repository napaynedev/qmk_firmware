...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,          KC_N,             KC_M,    KC_COMM, KC_DOT,    KC_RSFT, KC_FN2,
    KC_LCTL, KC_LGUI, KC_LALT, KC_FN1,  KC_FN1,                 KC_SPACE,                  KC_FN1,  KC_RALT,   KC_RGUI,  KC_RCTL
  ),

  [_FN1] = LAYOUT(
    _______, _______, _______, _______, _______, _______,       _______, KC_PGUP, KC_UP,   KC_PGDN, _______, _______, _______,
    _______, _______, _______, KC_CUT,  KC_COPY, KC_PSTE,       KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, _______,          _______,
